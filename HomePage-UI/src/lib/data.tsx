import { JavaIcon, CSharpIcon, LinkedinIcon, GithubIcon, SQLServerIcon, AzureIcon } from "@/components/icons";
import {
  SiNextdotjs,
  SiReact,
  SiTailwindcss,
...
export const blogPosts = [
  { title: "Demystifying Server-Side Rendering in Next.js", 
    date: "Aug 20, 2025", 
    excerpt: "A deep dive into why SSR is important and how to implement it efficiently in your Next.js applications.", 
    link: "#" 
  },
  { title: "Building a Scalable REST API with Node.js and TypeScript", 
    date: "July 15, 2025", 
    excerpt: "An end-to-end guide on creating a robust backend service with best practices for a software engineer.", 
    link: "#" 
  }
];
...
export const projectData = {
  ...
  overview: "Most public libraries still maintain old systems that make it impossible to lend books to customers, renew books, or receive useful recommendations. The systems take a long time to process and are difficult to use and require a lot of human labor from staff.",
  technical: "Built with **Next.js** for its hybrid rendering, **Tailwind CSS** for rapid styling, and a **.NET Core** backend for authentication and database management. Then deployed using **Kubernetes** on my cloud server.",
